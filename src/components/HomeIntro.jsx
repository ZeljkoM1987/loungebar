    ...
    <>
      ...
      <ParallaxProvider>
        <Parallax translateY={[-72, 30]}>
          <div className="intro-text">
            <h2>
              Sa ponosom vam predstavljamo našu raskošnu selekciju jela,
              pripremljenih sa strašću i pažnjom, kako biste uživali u svakom
              trenutku provedenom za stolom.
            </h2>
          </div>
        </Parallax>
      </ParallaxProvider>
      ...
      *
      <div className="dostava">
        ...
        <div className="dostava-text">
          ...
          <a className="button" href="tel:066954994">
